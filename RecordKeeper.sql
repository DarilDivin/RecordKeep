...
INSERT INTO `directions` (`id`, `direction`, `sigle`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(10, 'Nouvelle Direction 1', 'ND1', '2023-11-04 06:45:02', '2023-11-04 06:45:02', NULL);
...
INSERT INTO `divisions` (`id`, `division`, `sigle`, `service_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(68, 'Aucune', 'AUCUNE', 23, '2023-11-04 06:45:02', '2023-11-04 06:45:02', NULL),
	(69, 'Aucune', 'AUCUNE', 24, '2023-11-04 06:55:33', '2023-11-04 06:55:33', NULL),
	(70, 'Première Division du PSND1', 'PDPSND1', 24, '2023-11-04 07:03:31', '2023-11-04 07:03:31', NULL);

-- Listage des données de la table recordkeeper.documents : ~0 rows (environ)
INSERT INTO `documents` (`id`, `nom`, `timbre`, `code`, `objet`, `emetteur`, `recepteur`, `motclefs`, `datecreation`, `disponibilite`, `archive`, `prete`, `document`, `nbrdownload`, `nbrconsult`, `archived_at`, `created_at`, `updated_at`, `deleted_at`, `division_id`, `service_id`, `direction_id`, `nature_document_id`, `demande_transfert_id`, `chemise_dossier_id`) VALUES
	(1, 'Autorisation de stage', 'N°564/DPAF/MISP/SGHTE/DPRF/SA', NULL, 'Autorisation de stage', 'DPAF', 'Daniel', '#Économique#Commerciale', '2023-10-31', 0, 0, 0, 'documents/Exercices en C++.pdf', 0, 0, NULL, '2023-11-04 15:08:42', '2023-11-04 15:41:48', NULL, 29, 6, 2, 4, NULL, NULL);

-- Listage des données de la table recordkeeper.document_fonction : ~4 rows (environ)
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(6, '2023_07_17_194438_create_documents_table', 1),
	(7, '2023_07_17_195505_create_fonctions_table', 1),
	(8, '2023_07_17_195957_create_document_fonction_table', 1),
	(9, '2023_07_17_200142_create_directions_table', 1),
	(10, '2023_07_17_200259_create_services_table', 1),
	(11, '2023_07_17_200505_create_divisions_table', 1),
	(12, '2023_07_17_203111_create_nature_documents_table', 1),
	(13, '2023_07_17_203552_create_rayon_rangements_table', 1),
	(14, '2023_07_17_203700_create_boite_archives_table', 1),
	(15, '2023_07_17_203833_create_chemise_dossiers_table', 1),
	(16, '2023_07_17_210632_create_demande_prets_table', 1),
	(17, '2023_07_27_161439_create_demande_transferts_table', 1),
	(18, '2023_07_30_115348_create_categories_table', 1),
	(19, '2023_08_12_170330_create_rapport_prets_table', 1),
	(20, '2023_08_13_164013_create_jobs_table', 1),
	(21, '2023_08_16_195906_create_permission_tables', 1),
	(22, '2023_08_17_195007_add_foreigns_keys_to_users_table', 1),
	(23, '2023_08_23_202907_create_type_roles_table', 1),
	(24, '2023_08_23_203918_add_foreign_key_to_permissions_table', 1),
	(25, '2023_08_23_204336_add_foreign_key_to_roles_table', 1),
	(26, '2023_08_27_135446_add_foreign_keys_to_documents_table', 1),
	(27, '2023_08_31_164626_create_statistiques_table', 1),
	(28, '2023_09_09_173454_create_bordereau_transferts_table', 1),
	(29, '2023_11_01_143037_add_category_id_to_nature_documents_table', 1);
...
INSERT INTO `nature_documents` (`id`, `nature`, `dua_bureaux`, `dua_service_pre_archivage`, `created_at`, `updated_at`, `deleted_at`, `categorie_id`) VALUES
	(1, 'Decret', 7, 8, '2023-09-10 18:32:36', '2023-09-10 18:32:36', NULL, 2),
	(2, 'Arrêté',8, 10, '2023-09-10 18:32:50', '2023-09-10 18:32:50', NULL, 2),
	(3, 'Bordereau', 8, 11, '2023-09-10 18:33:07', '2023-09-10 18:33:45', NULL, 2),
	(4, 'Lettre', 7, 14, '2023-09-10 18:33:22', '2023-09-10 18:33:22', NULL, 2),
	(5, 'Courrier', 9, 16, '2023-09-10 18:33:32', '2023-09-10 18:33:40', NULL, 2),
	(6, 'Nouvelle Nature', 12, 18, '2023-11-04 07:49:33', '2023-11-04 07:49:33', NULL, 3);
...
INSERT INTO `services` (`id`, `service`, `sigle`, `direction_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(23, 'Aucun', 'AUCUN', 10, '2023-11-04 06:45:02', '2023-11-04 06:45:02', NULL),
	(24, 'Premier Service de la ND1', 'PSND1', 10, '2023-11-04 06:55:33', '2023-11-04 06:55:33', NULL);
...
-- Listage des données de la table recordkeeper.users : ~5 rows (environ)
INSERT INTO `users` (`id`, `matricule`, `nom`, `prenoms`, `email`, `datenaissance`, `sexe`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `created_at`, `updated_at`, `deleted_at`, `division_id`, `service_id`, `direction_id`, `fonction_id`) VALUES
	(1, 2632646, 'Doe', 'Jonh', 'jonh@doe.fr', '1975-02-06', 'masculin', '2023-09-10 16:55:59', '$2y$10$bDOML/RLGtSidQbrpxr.XOV4fUlCmF2Zez6vLEqRBv8i1Mhqal7FC', NULL, NULL, NULL, 'YL1toHR4I3yOvtQ7Tj0cAZMS682mzJYdVAgiU5LzvfNgRTYIxI25Ze0gopqW', '2023-09-10 16:55:59', '2023-09-10 19:10:45', NULL, 1, 1, 1, 1),
	(2, 8029737, 'Lawson', 'Tony', 'tony@lawson.fr', '1995-07-27', 'masculin', '2023-09-10 16:55:59', '$2y$10$Ri8xW44rtbR8mLrY/Noh/.Wue5WzX6Il0uximnn22gF6Lv89nnoCy', NULL, NULL, NULL, '4JbcbZD8WQtayPE8BanRiNPgs94NsRLLqwip95bDNwO87X7bEQ6wjpDThyfN', '2023-09-10 16:55:59', '2023-09-13 16:02:13', NULL, 4, 1, 1, 1),
	(3, 1804281, 'Lama', 'Lama', 'lama@lama.fr', '2001-12-31', 'masculin', '2023-09-10 16:55:59', '$2y$10$YicNDqYKsa8bp8znD3xEhOReV5et0LelmVmcv1vN7XKwa7waXPH/K', NULL, NULL, NULL, 'ddSYReBlAoTBt0RQXqMf0qLkr2cJE1m71H2i3WMD60Q85TqQmhm0oBMzliIm', '2023-09-10 16:55:59', '2023-11-05 13:09:28', NULL, 31, 7, 2, 4),
	(4, 5434134, 'Jackson', 'Jinard', 'jin@jack.fr', '2005-08-29', 'masculin', '2023-09-10 16:55:59', '$2y$10$iYxafdpGm3DncLY0lpAFieUXnbyXQr9lWLWnAOIK0J.ghvxE5vwwW', NULL, NULL, NULL, 'ZgRcmI8v9hXgu6kqFKbkkw7VSA1JPdhf1NXZh23G1iNPc8AaoZbR9CE3dN6i', '2023-09-10 16:55:59', '2023-09-13 16:02:46', NULL, 10, 5, 2, 3),
