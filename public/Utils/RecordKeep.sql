...
-- Listage des données de la table recordkeep.boite_archives : ~3 rows (environ)
...
-- Listage des données de la table recordkeep.categories : ~3 rows (environ)
INSERT INTO `categories` (`id`, `categorie`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(4, 'Catégorie de test ok', '2023-09-17 01:14:50', '2023-09-17 01:15:11', '2023-09-17 01:15:11');

-- Listage des données de la table recordkeep.chemise_dossiers : ~2 rows (environ)
...
-- Listage des données de la table recordkeep.demande_prets : ~1 rows (environ)
...
-- Listage des données de la table recordkeep.divisions : ~67 rows (environ)
...
-- Listage des données de la table recordkeep.document_fonction : ~14 rows (environ)
...
-- Listage des données de la table recordkeep.fonctions : ~5 rows (environ)
INSERT INTO `fonctions` (`id`, `fonction`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(5, 'Fonction de test ok', '2023-09-17 00:31:45', '2023-09-17 00:31:58', '2023-09-17 00:31:58');

-- Listage des données de la table recordkeep.jobs : ~2 rows (environ)
...
-- Listage des données de la table recordkeep.model_has_permissions : ~44 rows (environ)
...
-- Listage des données de la table recordkeep.model_has_roles : ~9 rows (environ)
...
-- Listage des données de la table recordkeep.nature_documents : ~5 rows (environ)
INSERT INTO `nature_documents` (`id`, `nature`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(6, 'Nature de test ok', '2023-09-17 01:14:02', '2023-09-17 01:14:13', '2023-09-17 01:14:13');
...
-- Listage des données de la table recordkeep.rayon_rangements : ~3 rows (environ)
...
-- Listage des données de la table recordkeep.roles : ~5 rows (environ)
INSERT INTO `roles` (`id`, `name`, `guard_name`, `created_at`, `updated_at`, `deleted_at`, `type_role_id`) VALUES
	...
	(5, 'Administrateur sans Gestion de Fonctions', 'web', '2023-09-17 00:56:33', '2023-09-17 00:56:33', NULL, 3);

-- Listage des données de la table recordkeep.role_has_permissions : ~25 rows (environ)
...
-- Listage des données de la table recordkeep.services : ~22 rows (environ)
...
-- Listage des données de la table recordkeep.statistiques : ~2 rows (environ)
...
-- Listage des données de la table recordkeep.users : ~6 rows (environ)
INSERT INTO `users` (`id`, `matricule`, `nom`, `prenoms`, `email`, `datenaissance`, `sexe`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `created_at`, `updated_at`, `deleted_at`, `division_id`, `service_id`, `direction_id`, `fonction_id`) VALUES
	(1, 2632646, 'Doe', 'Jonh', 'jonh@doe.fr', '1975-02-06', 'masculin', '2023-09-10 16:55:59', '$2y$10$bDOML/RLGtSidQbrpxr.XOV4fUlCmF2Zez6vLEqRBv8i1Mhqal7FC', NULL, NULL, NULL, 'kWNpOrYt4pGxVaob8OrmZ6Z4XffozXGh6jhkDQDXHK7TFCXku7lvEGVmEcAM', '2023-09-10 16:55:59', '2023-09-10 19:10:45', NULL, 1, 1, 1, 1),
	(2, 8029737, 'Lawson', 'Tony', 'tony@lawson.fr', '1995-07-27', 'masculin', '2023-09-10 16:55:59', '$2y$10$Ri8xW44rtbR8mLrY/Noh/.Wue5WzX6Il0uximnn22gF6Lv89nnoCy', NULL, NULL, NULL, 'b0qHHfrlfAKDgTHiqgRs0OLgCSDiyGsNB04ADMeWVpTQl6xwLEkx0BvaBpM4', '2023-09-10 16:55:59', '2023-09-13 16:02:13', NULL, 4, 1, 1, 1),
	(3, 1804281, 'Lossin', 'Lobert', 'lossin@lobert.fr', '2001-12-31', 'masculin', '2023-09-10 16:55:59', '$2y$10$0Jh3ZgFvRrQO42IDU9hkHuGthyrfZ5UvU4PbFy6EBNwAku2rcbAqW', NULL, NULL, NULL, 'b7WkA26Hdv1dPPh0rihMxN9xnNnwxgorDqGaQ43jmDjnTLEdgRoB3cRvIgLT', '2023-09-10 16:55:59', '2023-09-13 16:04:27', NULL, 1, 7, 2, 4),
