...
INSERT INTO `bordereau_transferts` (`id`, `observation`, `demande_transfert_id`, `created_at`, `updated_at`) VALUES
	(1, 'Bien reçu', 1, '2023-09-10 19:41:13', '2023-09-10 19:41:13');
...
INSERT INTO `demande_prets` (`id`, `motif`, `duree`, `etat`, `user_id`, `document_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Personnelle', 15, 'encour', 1, 3, '2023-09-10 20:24:09', '2023-09-10 20:24:09', NULL);

-- Listage des données de la table recordkeep.demande_transferts : ~0 rows (environ)
INSERT INTO `demande_transferts` (`id`, `libelle`, `transfere`, `valide`, `user_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Transfert', 1, 1, 1, '2023-09-10 19:33:43', '2023-09-10 19:41:13', NULL),
	(2, 'Trans 2', 0, 0, 1, '2023-09-10 19:36:34', '2023-09-10 19:37:20', '2023-09-10 19:37:20'),
	(3, 'Trans 5', 0, 0, 1, '2023-09-10 19:38:47', '2023-09-10 19:38:47', NULL);

-- Listage des données de la table recordkeep.directions : ~9 rows (environ)
...
-- Listage des données de la table recordkeep.divisions : ~10 rows (environ)
...
-- Listage des données de la table recordkeep.documents : ~3 rows (environ)
INSERT INTO `documents` (`id`, `nom`, `signature`, `code`, `objet`, `source`, `emetteur`, `recepteur`, `motclefs`, `dua`, `datecreation`, `disponibilite`, `archive`, `prete`, `document`, `nbrdownload`, `nbrconsult`, `archived_at`, `created_at`, `updated_at`, `deleted_at`, `division_id`, `service_id`, `direction_id`, `categorie_id`, `nature_document_id`, `demande_transfert_id`, `chemise_dossier_id`) VALUES
	(1, 'AOF DSI', 'N°564/DPAF/MISP/SGHTE/DPRF/SA', 'R1B3CH21', 'AOF DSI', 'DPAF', 'DPAF', 'Daniel', '#Économique#Magistrat', 10, '2023-09-14', 1, 1, 0, 'documents/AOF DSI.pdf', 0, 0, NULL, '2023-09-10 18:37:41', '2023-09-10 19:48:51', NULL, 1, 1, 1, 1, 1, 1, 2),
	(2, 'AOF DAIC', 'N°564/DPAF/MISP/DPRF/SA', NULL, 'AOF DAIC', 'DPAF', 'DPAF', 'Daniel', '#Magistrat#Capitaliste', 10, '2023-09-19', 1, 0, 0, 'documents/AOF DAIC.pdf', 1, 0, NULL, '2023-09-10 18:39:34', '2023-09-10 20:16:09', NULL, 1, 1, 1, 1, 1, 3, NULL),
	(3, 'AOF DPAF', 'N°564/DPAF/MISP/DPRF/SAAA', NULL, 'AOF DPAF', 'DPAF', 'DPAF', 'Daniel', '#Administratif#Économique', 10, '2023-09-13', 1, 0, 0, 'documents/AOF DPAF.pdf', 1, 0, NULL, '2023-09-10 18:40:37', '2023-09-10 20:16:09', NULL, 1, 1, 1, 1, 1, 3, NULL);
...
-- Listage des données de la table recordkeep.model_has_permissions : ~29 rows (environ)
...
-- Listage des données de la table recordkeep.model_has_roles : ~7 rows (environ)
...
-- Listage des données de la table recordkeep.permissions : ~20 rows (environ)
...
-- Listage des données de la table recordkeep.roles : ~4 rows (environ)
...
-- Listage des données de la table recordkeep.role_has_permissions : ~20 rows (environ)
...
-- Listage des données de la table recordkeep.services : ~8 rows (environ)
...
-- Listage des données de la table recordkeep.type_roles : ~4 rows (environ)
...
-- Listage des données de la table recordkeep.users : ~5 rows (environ)
INSERT INTO `users` (`id`, `matricule`, `nom`, `prenoms`, `email`, `datenaissance`, `sexe`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `created_at`, `updated_at`, `deleted_at`, `division_id`, `service_id`, `direction_id`, `fonction_id`) VALUES
	...
	(2, 8029737, 'Lawson', 'Tony', 'tony@lawson.fr', '1995-07-27', 'masculin', '2023-09-10 16:55:59', '$2y$10$BuOkUgQ2DUFeuiLd5VXSM.ldf/HOfKFtGzhS.89j/1DvM89x.YPI6', NULL, NULL, NULL, 'loW8aD6Xc8', '2023-09-10 16:55:59', '2023-09-10 19:04:52', NULL, 1, 1, 1, 1),
	(3, 1804281, 'Lossin', 'Lobert', 'lossin@lobert.fr', '2001-12-31', 'masculin', '2023-09-10 16:55:59', '$2y$10$Y/Khf8ju8pt8MbBMU7nI0uK5DpxzNvgEYjS6m42CUs0lJBOqjM4Ua', NULL, NULL, NULL, '754jtGt0it', '2023-09-10 16:55:59', '2023-09-10 19:08:37', NULL, NULL, 7, 2, 4),
	(4, 5434134, 'Jackson', 'jinard', 'jin@jack.fr', '2005-08-29', 'masculin', '2023-09-10 16:55:59', '$2y$10$C1Nsot6vsWWWFsRtz8wSSeDrg7JcvuCM34k1mweMVwiZy8Y/wpyb2', NULL, NULL, NULL, '97XSWy6usC', '2023-09-10 16:55:59', '2023-09-10 19:06:04', NULL, 10, 5, 2, 3),
	(5, 303030, 'DJK', 'Divin', 'divindjk@gmail.com', '2004-05-30', 'masculin', NULL, '$2y$10$aLfvYCUC/lsDJETGVnp7b.d/giHFtzcVgfHaX6ei/9NcIYCnleqOG', NULL, NULL, NULL, NULL, '2023-09-10 18:47:13', '2023-09-10 18:47:13', NULL, 4, 1, 1, 1);
