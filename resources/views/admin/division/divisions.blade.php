                                ...
                                <td>
                                    ...
                                    <button class="delete">
                                        <a href="{{ route('admin.division.destroy', ['division' => $division->id]) }}"
                                           ...
                                           document.getElementById('deleteForm{{ $division->id }}').submit();">
                                            Supprimer
                                        </a>
                                        <form action="{{ route('admin.division.destroy', ['division' => $division->id]) }}" method="POST" style="" id="deleteForm{{ $division->id }}">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </button>
