                        ...
                        @forelse ($natures as $nature)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="delete">
                                        <a href="{{ route('admin.nature.destroy', ['nature' => $nature->id]) }}"
                                           onclick="event.preventDefault();
                                           document.getElementById('deleteForm{{ $nature->id }}').submit();">
                                            Supprimer
                                        </a>
                                        <form action="{{ route('admin.nature.destroy', ['nature' => $nature->id]) }}" method="POST" style="" id="deleteForm{{ $nature->id }}">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </button>
