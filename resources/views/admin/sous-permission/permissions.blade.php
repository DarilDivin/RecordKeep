            ...
            <div class="optional">
                <div class="buttons">
                    ...
                    <button class="add">
                        ...
                        <a href="{{ route('admin.sous-permission.create') }}">Add Sous-Permission</a>
                    </button>
                </div>
                <form action="">
                    ...
                    <tbody>
                        @forelse ($permissions as $permission)
                            <tr>
                                ...
                                <td>
                                    <button class="edit">
                                        <a href="{{ route('admin.sous-permission.edit', ['sous_permission' => $permission->id]) }}">
                                            Editer
                                        </a>
                                    </button>
                                    <button class="delete">
                                        <a href="{{ route('admin.sous-permission.destroy', ['sous_permission' => $permission->id]) }}"
                                           onclick="event.preventDefault();
                                           document.getElementById('deleteForm{{ $permission->id }}').submit();">
                                            Supprimer
                                        </a>
                                        <form action="{{ route('admin.sous-permission.destroy', ['sous_permission' => $permission->id]) }}" method="POST" style="" id="deleteForm{{ $permission->id }}">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </button>
                        ...
                        @empty
                            Aucune Sous-Permission en base de données
                        @endforelse
                    </tbody>
                </table>
            </div>
