                        ...
                        @forelse ($categories as $categorie)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="delete">
                                        <a href="{{ route('admin.categorie.destroy', ['categorie' => $categorie->id]) }}"
                                           onclick="event.preventDefault();
                                           document.getElementById('deleteForm{{ $categorie->id }}').submit();">
                                            Supprimer
                                        </a>
                                        <form action="{{ route('admin.categorie.destroy', ['categorie' => $categorie->id]) }}" method="POST" style="" id="deleteForm{{ $categorie->id }}">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </button>
