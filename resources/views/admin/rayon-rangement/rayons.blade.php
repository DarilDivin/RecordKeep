                        ...
                        @forelse ($rayons as $rayon)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="delete">
                                        <a href="{{ route('admin.rayon.destroy', ['rayon' => $rayon->id]) }}"
                                           onclick="event.preventDefault();
                                           document.getElementById('deleteForm{{ $rayon->id }}').submit();">
                                            Supprimer
                                        </a>
                                        <form action="{{ route('admin.rayon.destroy', ['rayon' => $rayon->id]) }}" method="POST" style="" id="deleteForm{{ $rayon->id }}">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </button>
