                        ...
                        @forelse ($chemises as $chemise)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="delete">
                                        <a href="{{ route('admin.chemise.destroy', ['chemise' => $chemise->id]) }}"
                                           onclick="event.preventDefault();
                                           document.getElementById('deleteForm{{ $chemise->id }}').submit();">
                                            Supprimer
                                        </a>
                                        <form action="{{ route('admin.chemise.destroy', ['chemise' => $chemise->id]) }}" method="POST" style="" id="deleteForm{{ $chemise->id }}">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </button>
