                        ...
                        @forelse ($typeroles as $typerole)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="delete">
                                        <a href="{{ route('admin.type-role.destroy', ['type_role' => $typerole->id]) }}"
                                           onclick="event.preventDefault();
                                           document.getElementById('deleteForm{{ $typerole->id }}').submit();">
                                            Supprimer
                                        </a>
                                        <form action="{{ route('admin.type-role.destroy', ['type_role' => $typerole->id]) }}" method="POST" style="" id="deleteForm{{ $typerole->id }}">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </button>
