...
class DemandeTransfertController extends Controller
{
    ...
    {
        return view('admin.demande-transfert.transferts', [
    ...
    public function create(): View | RedirectResponse
    {
        ...
        return view('admin.demande-transfert.transfert-form', [
    ...
    public function show(string $slug, DemandeTransfert $transfert): View | RedirectResponse
    {
        ...
        if(!$transfert->transfere){
            ...
            return view('admin.demande-transfert.transfert-show', [
                'transfert' => $transfert
            ]);
        }
        return redirect()->route('admin.transfert.index');
    }
